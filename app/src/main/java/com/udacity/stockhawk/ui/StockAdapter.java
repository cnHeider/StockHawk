...
class StockAdapter extends RecyclerView.Adapter<StockAdapter.StockViewHolder> {
  ...
  public void onBindViewHolder(StockViewHolder holder, int position) {
    ...
    holder.price.setText(mFormatters.dollarFormat.format(cursor.getFloat(Contract.Quote.POSITION_PRICE)));
    ...
    String change = mFormatters.dollarFormatWithPlus.format(rawAbsoluteChange);
    String percentage = mFormatters.percentageFormat.format(percentageChange / 100);
